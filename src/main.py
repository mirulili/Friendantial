...
from app.llm_clients import OpenAIChatClient, GeminiChatClient # 사용할 LLM 클라이언트들 임포트
from app.db_models import Base, RecommendationRun, RecommendedStock
from app.routers import analysis, market, history, reporting, mcp, recommend
...
async def lifespan(app: FastAPI):
    ...
    # --- 공통 유틸리티 함수 등록 ---
    from app.market_data import _fetch_stock_info
    ...
    if app.state.llm_client is None:
        logging.warning("LLM 클라이언트가 초기화되지 않았습니다. LLM_PROVIDER 및 해당 API 키 환경 변수를 확인하세요.")
